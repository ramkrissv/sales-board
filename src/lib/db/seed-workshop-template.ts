      ...
      levels: [
        ...
        },
        {
          ...
          dimensions: [
            ...
            { id: '2.3', name: 'GCP Foundation', probe: 'Are landing zone, networking, identity, and cost controls established on GCP?', workstreamCode: 'WS6', order: 2 },
            { id: '2.4', name: 'Kiro & Agent Build Framework', probe: 'Are agents built with a consistent framework, lifecycle, and versioning in Kiro?', workstreamCode: 'WS2', order: 3 },
        ...
        },
        {
          ...
          dimensions: [
            ...
            { id: '3.7', name: 'Compliance (Okta, PCI, SOX)', probe: 'Are identity, payment, and financial-control obligations met by design?', workstreamCode: 'WS7', order: 6 },
